...
export default async function Page({
  ...
  return (
    <section className='text-CustomWhite'>
      <ul className='grid grid-flow-row grid-cols-[repeat(auto-fit,150px)] items-center justify-center gap-y-5 gap-x-3 py-5 lg:grid-cols-[repeat(3,minmax(275px,1fr))]'>
